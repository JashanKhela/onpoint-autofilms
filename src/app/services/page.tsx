      ...
      <section className="relative bg-zinc-950 text-white py-32 px-6 md:px-12 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center">
          ...
          <p className="text-zinc-400 text-lg md:text-xl max-w-2xl mx-auto mb-8">
            Industry-leading wraps, coatings, and protection—flawlessly
            installed for those who expect the best.
          </p>
          <Link href="/contact" className="inline-block">
            <Button
              size="lg"
              variant="default"
              className="bg-neon-pink text-black hover:bg-neon-teal hover:text-white transition-all duration-300 px-8 py-4 text-xl rounded-xl"
            >
              Get a Quote
            </Button>
          </Link>
      ...
      <section className="bg-zinc-950 text-white px-6 md:px-12 py-12">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-zinc-400 text-lg leading-relaxed">
            At OnPoint Auto Films, we take serious pride in every wrap, tint,
            and polish. Every project is a reflection of our passion for
            perfection. We don’t settle for anything less than flawless — and
            neither should you. That’s why we offer a{" "}
            <span className="text-white font-semibold">
              lifetime installation warranty
            </span>{" "}
            and back our work with unmatched customer care.
          </p>
        </div>
      </section>
